...
req = requests.get("https://api.coingecko.com/api/v3/coins/ethereum/market_chart?vs_currency=usd&days=max&interval=daily")
...
dxd_withdrawls = be.events.Withdraw.createFilter(fromBlock=0, argument_filters={'user': gp_relay.address, 'token': '0xb90D6bec20993Be5d72A5ab353343f7a0281f158'}).get_all_entries()
dxd_withdrawn = Wei(sum([i['args']['amount'] for i in dxd_withdrawls]))
dxd_balance = Wei(be.functions.getBalance(gp_relay.address, '0xb90D6bec20993Be5d72A5ab353343f7a0281f158').call())
